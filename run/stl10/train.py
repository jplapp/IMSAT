...
def main():
	...
	import tools.stl10 as stl10

	images_train, labels_train = stl10.get_data('train', max_num=72000)  # no train labels nowhere
	images_test, labels_test = stl10.get_data('test', max_num=20000)
